...
static inline x86mmu_cr3__t x86mmu_cr3__rd(x86mmu__t * unit) {
    x86mmu_cr3__t val;
    val = x86mmu_cr3__set_raw(os_mmio_register_read_64((unit)->base, 0x0));
    return val;
}
...
static inline void x86mmu_cr3__wr(x86mmu__t * unit, x86mmu_cr3__t val) {
    os_mmio_register_write_64((unit)->base, 0x0, x86mmu_cr3__get_raw(val));
}
...
static inline x86mmu_cr4__t x86mmu_cr4__rd(x86mmu__t * unit) {
    x86mmu_cr4__t val;
    val = x86mmu_cr4__set_raw(os_mmio_register_read_32((unit)->base, 0x8));
    return val;
}
...
static inline void x86mmu_cr4__wr(x86mmu__t * unit, x86mmu_cr4__t val) {
    os_mmio_register_write_32((unit)->base, 0x8, x86mmu_cr4__get_raw(val));
}
